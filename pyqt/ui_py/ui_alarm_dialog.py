...
"}")
        ...
        item = QtWidgets.QTableWidgetItem()
        self.alarm_list_widget.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.alarm_list_widget.setItem(0, 1, item)
...
"QPushButton::disabled{background-color:#cbcbcb}")
    ...
    def retranslateUi(self, Dialog):
        ...
        item = self.alarm_list_widget.verticalHeaderItem(0)
        ...
        __sortingEnabled = self.alarm_list_widget.isSortingEnabled()
        self.alarm_list_widget.setSortingEnabled(False)
        item = self.alarm_list_widget.item(0, 0)
        item.setText(_translate("Dialog", "dawd"))
        item = self.alarm_list_widget.item(0, 1)
        item.setText(_translate("Dialog", "awd"))
        self.alarm_list_widget.setSortingEnabled(__sortingEnabled)
