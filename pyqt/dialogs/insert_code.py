...
class InsertCodeDialog(QDialog):
    ...
    def __init__(self, parents=None):
        ...
        self.etapa_validator = QRegExpValidator(regex_etapa)
        self.code_validator = QRegExpValidator(regex_code)
        self.pos_validator = QRegExpValidator(regex_pos)
    ###################################################################################################
    ...
    def show_dialog(self, ui_main: Ui_MainWindow, side: Literal["A1", "A2", "B1", "B2"]):
        ...
        """
        self.ui.le_etapa.setValidator(self.etapa_validator)
        self.ui.le_code.setValidator(self.code_validator)
        self.ui.le_pos.setValidator(self.pos_validator)
