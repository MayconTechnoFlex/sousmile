...
def pos_filter(in_data: DataFrame, lx: List[float], ly: List[float], lz: List[float],
    ...
    :param var_limit_D: Variavél para o limite em D
    :param var_limit_C: Variavél para o limite em C
    :param var_limit_XYZ: Variavél para o limite de distancia entre os pontos
    :param var_limit_h: Variavél para o limite de h diferença de altura entre os pontos
