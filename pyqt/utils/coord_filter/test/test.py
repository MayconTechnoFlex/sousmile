"""Funções para teste de arquivo local"""
#######################################################################################################
# Importações
#######################################################################################################
...
# Função
#######################################################################################################
def test_file(file_path: str, lx: List[float], ly: List[float], lz: List[float],
              lc: List[float], ld: List[float], l_pos: List[int], l_info: List[str],
              var_limit_d: float, var_limit_c: float, var_limit_xyz: float, var_limit_h: float, var_p: float) -> int:
    """
    Função para teste do filtro de pontos

    :param file_path: Caminho até o arquivo
    ...
    :param var_limit_d: variável para o limite de d
    :param var_limit_c: variável para o limite de c
    :param var_limit_xyz: variável para o limite da distância entre os pontos
    :param var_limit_h: variaávelpara o limite da altura do ponto
    :param var_p: variável para a profundidade do corte
